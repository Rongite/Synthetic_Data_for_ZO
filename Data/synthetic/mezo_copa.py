...
data = []
with open('/home/jlong1/Downloads/Data/zo/0_original_data/COPA/copa_train.jsonl', 'r', encoding='utf-8') as file: # input file
    for line in file:
            # 解析每一行的 JSON 数据，并将其附加到 data 列表中
        data.append(json.loads(line.strip()))

output_file = os.path.expanduser("/home/jlong1/Downloads/Data/zo/1_original_zo/synthetic/COPA/copa_train.jsonl") # output file

os.makedirs(os.path.dirname(output_file), exist_ok=True)
out_file = open(output_file, "w")

error_file = os.path.expanduser("/home/jlong1/Downloads/Data/zo/1_original_zo/synthetic/COPA/err_data/err_data.jsonl") # error file
