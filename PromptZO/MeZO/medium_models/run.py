...
class DynamicTrainingArguments(TrainingArguments):
    ...
    use_squeezellm: bool = field(
        default=False
    )

    squeezellm_ckpt: str = field(
        default=None
    )

    squeezellm_wbits: int = field(
        default=4
    )
    ...
    random_subset_weights: bool = field(
        default=False
    )

    dynamic_mask: bool = field(
        default=False
    )

    dynamic_mask_step: int = field(
        default=100
    )
