...
C4_GRAD=${C4_GRAD:-/share/desa/nfs02/wg247/SqueezeLLM/grad/llama2-7b/squeezellm-gradients}
MODE=${MODE:-ft}
TAG=mezo-$TASK-$MODE-$STEPS-$BS-$LR-$EPS-$SEED-C4-grad-$PERCENTAGE
...
echo "EPS: $EPS"
echo "SEED: $SEED"
echo "OUTLIER_PERCENTAGE: $PERCENTAGE"
...
python run.py \
    ...
    --C4_grad_mask --C4_grad_addr $C4_GRAD --outlier_percentage $PERCENTAGE \
