...
GRAD_STEP=${GRAD_STEP:-100}
MODE=${MODE:-ft}
TAG=mezo-$TASK-$MODE-$STEPS-$BS-$LR-$EPS-$SEED-grad-dynamic-$GRAD_STEP-$PERCENTAGE
...
python run.py \
    ...
    --grad_mask --outlier_percentage $PERCENTAGE \
    --dynamic_mask --dynamic_mask_step $GRAD_STEP \
