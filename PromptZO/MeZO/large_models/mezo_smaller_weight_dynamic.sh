...
MODE=${MODE:-ft}
TAG=mezo-$TASK-$MODE-$STEPS-$BS-$LR-$EPS-$SEED-smaller_weight-$PERCENTAGE-dynamic
...
python run.py \
    ...
    --smaller_weight_mask --outlier_percentage $PERCENTAGE --dynamic_mask --dynamic_mask_step 100 \
