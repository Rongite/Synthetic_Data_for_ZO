...
CUDA_VISIBLE_DEVICES=0 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=5e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_1 2>>$ERR_1
...
CUDA_VISIBLE_DEVICES=0 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=2e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_2 2>>$ERR_2
...
CUDA_VISIBLE_DEVICES=0 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=1e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_3 2>>$ERR_3
