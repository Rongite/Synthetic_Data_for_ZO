...
OUT_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/1e-6_synthetic.out
ERR_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/1e-6_synthetic.err
CUDA_VISIBLE_DEVICES=0 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=1e-6 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_0 2>>$ERR_0

OUT_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/5e-7_synthetic.out
ERR_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/5e-7_synthetic.err
CUDA_VISIBLE_DEVICES=1 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=5e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_1 2>>$ERR_1

OUT_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/2e-7_synthetic.out
ERR_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/2e-7_synthetic.err
CUDA_VISIBLE_DEVICES=2 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=2e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_2 2>>$ERR_2

OUT_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/1e-7_synthetic.out
ERR_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-1B/RTE/zo/rejection_sampling/1e-7_synthetic.err
CUDA_VISIBLE_DEVICES=3 MODEL=mistralai/Mistral-Nemo-Base-2407 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/RTE LR=1e-7 BS=16 STEPS=20000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_3 2>>$ERR_3
