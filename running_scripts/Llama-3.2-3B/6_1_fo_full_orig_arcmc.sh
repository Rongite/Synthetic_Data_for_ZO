...
OUT_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/1e-6_original.out
ERR_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/1e-6_original.err
...
OUT_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/5e-7_original.out
ERR_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/5e-7_original.err
...
OUT_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/2e-7_original.out
ERR_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/2e-7_original.err
...
OUT_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/1e-7_original.out
ERR_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Llama-3.2-3B/ArcC_MC/fo_full/original/1e-7_original.err
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=1e-6 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_0 2>>$ERR_0 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=5e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_1 2>>$ERR_1 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=2e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_2 2>>$ERR_2 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=1e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_3 2>>$ERR_3 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/jlong1/Downloads/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=1e-6 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_0 2>>$ERR_0 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/jlong1/Downloads/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=5e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_1 2>>$ERR_1
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/jlong1/Downloads/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=2e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_2 2>>$ERR_2 &
...
# MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/home/jlong1/Downloads/Synthetic_Data_for_ZO/Data/original/ArcC_MC LR=1e-7 BS=16 STEPS=20000 SEED=0 bash fo_full_finetune_original.sh --gradient_accumulation_steps 4 1>>$OUT_3 2>>$ERR_3 &
