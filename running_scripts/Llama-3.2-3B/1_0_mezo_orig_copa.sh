...
CUDA_VISIBLE_DEVICES=0 MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/grand/sbi-fair/jikaiLoong/Synthetic_Data_for_ZO/Data/original/Copa LR=1e-6 BS=4 STEPS=20000 SEED=0 bash mezo_finetune_original.sh 1>>$OUT_0 2>>$ERR_0 &
...
CUDA_VISIBLE_DEVICES=1 MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/grand/sbi-fair/jikaiLoong/Synthetic_Data_for_ZO/Data/original/Copa LR=5e-7 BS=4 STEPS=20000 SEED=0 bash mezo_finetune_original.sh 1>>$OUT_1 2>>$ERR_1 &
...
CUDA_VISIBLE_DEVICES=2 MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/grand/sbi-fair/jikaiLoong/Synthetic_Data_for_ZO/Data/original/Copa LR=2e-7 BS=4 STEPS=20000 SEED=0 bash mezo_finetune_original.sh 1>>$OUT_2 2>>$ERR_2 &
...
CUDA_VISIBLE_DEVICES=3 MODEL=meta-llama/Llama-3.2-3B MODE=ft TASK=/grand/sbi-fair/jikaiLoong/Synthetic_Data_for_ZO/Data/original/Copa LR=1e-7 BS=4 STEPS=20000 SEED=0 bash mezo_finetune_original.sh 1>>$OUT_3 2>>$ERR_3 &
