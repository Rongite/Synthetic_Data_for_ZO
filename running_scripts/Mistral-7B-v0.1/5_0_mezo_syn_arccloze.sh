...
OUT_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/1e-6_synthetic.out
ERR_0=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/1e-6_synthetic.err
MODEL=mistralai/Mistral-7B-v0.1 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/ArcC_Cloze LR=1e-6 BS=4 STEPS=80000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_0 2>>$ERR_0 &

OUT_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/5e-7_synthetic.out
ERR_1=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/5e-7_synthetic.err
MODEL=mistralai/Mistral-7B-v0.1 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/ArcC_Cloze LR=5e-7 BS=4 STEPS=80000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_1 2>>$ERR_1 &

OUT_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/2e-7_synthetic.out
ERR_2=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/2e-7_synthetic.err
MODEL=mistralai/Mistral-7B-v0.1 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/ArcC_Cloze LR=2e-7 BS=4 STEPS=80000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_2 2>>$ERR_2 &

OUT_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/1e-7_synthetic.out
ERR_3=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/results/Mistral-7B-v0.1/ArcC_Cloze/zo/rejection_sampling/1e-7_synthetic.err
MODEL=mistralai/Mistral-7B-v0.1 MODE=ft TASK=/home/ubuntu/LLM-inference/jikai-project/Synthetic_Data_for_ZO/Data/rejection_sampling/0_data/ArcC_Cloze LR=1e-7 BS=4 STEPS=80000 SEED=0 bash mezo_finetune_synthetic.sh 1>>$OUT_3 2>>$ERR_3 &
